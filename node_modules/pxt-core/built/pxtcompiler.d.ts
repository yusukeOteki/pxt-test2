...
declare namespace ts.pxtc {
    ...
    abstract class AssemblerSnippets {
        ...
        string_literal(lbl: string, s: string): string;
    ...
    class ProctoAssembler {
        ...
        private alignedCall(name, cmt?, off?);
...
declare namespace ts.pxtc {
    ...
    class ThumbSnippets extends AssemblerSnippets {
        ...
        pushLR(): "push {lr, r6}  ; r6 for align" | "push {lr}";
        popPC(): "pop {pc}" | "pop {pc, r6}  ; r6 for align";
        nop(): string;
        ...
        load_ptr(lbl: string, reg: string): string;
        lambda_init(): string;
        inline_decr(idx: number, stackSize: number): string;
        arithmetic(): string;
        emit_int(v: number, reg: string): string;
    }
}
...
declare namespace ts.pxtc {
    ...
    type EmittableAsCall = FunctionLikeDeclaration | SignatureDeclaration | ObjectLiteralElementLike | PropertySignature | ModuleDeclaration;
    function getNodeId(n: Node): number;
    function stringKind(n: Node): any;
    function isThumb(): boolean;
    function sizeOfBitSize(b: BitSize): 1 | 2 | 4;
...
declare namespace ts.pxtc {
    ...
    const numSpecialMethods = 3;
    function vtableToAsm(info: ClassInfo, opts: CompileOptions): string;

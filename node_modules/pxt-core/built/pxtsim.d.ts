...
declare namespace pxsim {
    ...
    interface SimulatorBLEPacketMessage extends SimulatorMessage {
        type: "blepacket";
        packet: Uint8Array;
    }
...
declare namespace pxsim {
    ...
    namespace langsupp {
        ...
        function ptreqDecr(a: any, b: any): boolean;
    }
    namespace pxtcore {
    ...
    namespace pxtrt {
        ...
        function mapSet(map: RefMap, key: number, val: any, keyName?: string): void;
        function mapSetRef(map: RefMap, key: number, val: any, keyName?: string): void;
...
declare namespace pxsim {
    ...
    class EventBusGeneric<T> {
        ...
        constructor(runtime: Runtime, valueToArgs?: EventValueToActionArgs<T>);
        private start(id, evid, create, background);

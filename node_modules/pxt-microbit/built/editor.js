    ...
    (function (editor) {
      ...
      */
        ...
        function showUploadInstructionsAsync(fn, url, confirmAsync) {
            var boardName = pxt.Util.htmlEscape(pxt.appTarget.appTheme.boardName || "???");
            var boardDriveName = pxt.Util.htmlEscape(pxt.appTarget.appTheme.driveDisplayName || pxt.appTarget.compile.driveName || "???");

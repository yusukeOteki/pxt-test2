...
(function (pxsim) {
    ...
    (function (radio) {
        ...
        function setTransmitSerialNumber(transmit) {
            pxsim.board().radioState.setTransmitSerialNumber(transmit);
        }
        ...
        function receivedNumber() {
            return pxsim.board().radioState.datagram.lastReceived.payload.numberData || 0;
        }
        radio.receivedNumber = receivedNumber;
        function receivedSerial() {
            return pxsim.board().radioState.datagram.lastReceived.serial;
        }
        radio.receivedSerial = receivedSerial;
        function receivedString() {
            return pxsim.initString(pxsim.board().radioState.datagram.lastReceived.payload.stringData || "");
        }
        radio.receivedString = receivedString;
        function receivedBuffer() {
            return new pxsim.RefBuffer(pxsim.board().radioState.datagram.lastReceived.payload.bufferData || new Uint8Array(0));
        }
        radio.receivedBuffer = receivedBuffer;
        function receivedTime() {
            return pxsim.board().radioState.datagram.lastReceived.time;
        }
